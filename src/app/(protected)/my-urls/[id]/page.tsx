...
import { displayLocation, getDate, validateUrl } from "@/lib/helpers";
                ...
                {editingTitle ? (
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="flex cursor-pointer h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#111111] text-white hover:opacity-80"
                    ...
                    <button
                      ...
                      className="flex cursor-pointer h-9 w-9 shrink-0 items-center justify-center rounded-full border border-gray-300 hover:bg-white/50"
                  ...
                  <div className="flex flex-col items-center justify-start gap-4 sm:flex-row">
                    ...
                    <button
                      ...
                      className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-full text-gray-400 transition-colors hover:bg-white/60 hover:text-black"
              ...
              <div className="border-y border-gray-300/70 py-10">
                ...
                <div className="text-center">
                  ...
                  <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                    ...
                    <button
                      onClick={handleCopy}
                      className="inline-flex cursor-pointer shrink-0 items-center gap-2 rounded-full border border-[#111111] bg-[#111111] px-5 py-2.5 text-sm font-medium text-white transition-all hover:bg-transparent hover:text-[#111111]"
                    >
                  ...
                  {editingLongUrl ? (
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex shrink-0 gap-2 pt-2">
                        <button
                          onClick={saveLongUrl}
                          className="flex h-9 cursor-pointer w-9 items-center justify-center rounded-full bg-[#111111] text-white hover:opacity-80"
                          aria-label="Save URL"
                        >
                          <Check size={16} />
                        </button>
                        ...
                        <button
                          ...
                          className="flex h-9 cursor-pointer w-9 items-center justify-center rounded-full border border-gray-300 hover:bg-white/50"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="mt-1 flex h-12 w-12 cursor-pointer shrink-0 items-center justify-center rounded-full text-gray-400 transition-colors hover:bg-white/60 hover:text-black"
                        aria-label="Edit URL"
                      >
                        <PenLine size={20} />
                      </button>
                    ...
                    {!editingExpiry ? (
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="flex cursor-pointer h-8 w-8 items-center justify-center rounded-full text-gray-400 transition-colors hover:bg-white/60 hover:text-black"
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger>
                          <button
                            type="button"
                            aria-label="Location accuracy information"
                            className="hover:text-gray-400 transition text-[#3c2d11]"
                          >
                        ...
                        <TooltipContent className="max-w-xs text-center">
                          <p>
                            Location is estimated from the visitor&apos;s
                            network provider and may not always be accurate,
                            especially on Wi-Fi or shared networks.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
